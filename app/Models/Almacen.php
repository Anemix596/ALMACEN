...
class Almacen extends Model
{
    ...
    public static function actualizar_pedido_almacen($usuario, $no_pedido, $valor, $responsable)
    {
        $query = DB::select("SELECT * FROM actualizar_pedido_almacen('$usuario', '$no_pedido', '$valor', '$responsable')");
        return $query;
    }
    ...
    public static function listar_orden_almacen5()
    {
        $query = DB::select("SELECT * FROM listar_orden_almacen5()");
        return $query;
    }
}
