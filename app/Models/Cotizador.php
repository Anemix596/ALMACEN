...
class Cotizador extends Model
{
    ...
    public static function recuperar_datos_prov_nacional($id_solicitud, $usuario, $valor){
        $query=DB::select("SELECT * FROM recuperar_datos_prov_nacional('$id_solicitud', '$usuario', '$valor')");
        return $query;
    }
