...
class Presupuesto extends Model
{
    ...
    public static function actualizar_fuente_fnto($no_pedido, $fuente, $organo, $fuente_fnto, $est_prog, $usuario){
        $query=DB::select("SELECT actualizar_fuente_fnto('$no_pedido', '$fuente', '$organo', '$fuente_fnto', '$est_prog', '$usuario')");
        return $query;
    }
