...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('inicio_activos', [SolicitanteController::class, 'vista_activos']);
    ...
    Route::post('/recuperar_superior_responsable', [SolicitanteController::class, 'recuperar_superior_responsable'])->name('recuperar.superior.responsable');
    ...
    Route::get('lista_activos', [SolicitanteController::class, 'lista_activos']);
    Route::get('lista_suministros', [SolicitanteController::class, 'lista_suministros']);
    Route::get('/ver_lista_activos', [SolicitanteController::class, 'ver_lista_activos'])->name('ver.lista.activos');
    Route::get('/ver_lista_suministros', [SolicitanteController::class, 'ver_lista_suministros'])->name('ver.lista.suministros');
    Route::post('/ver_lista_suministros_valor', [SolicitanteController::class, 'ver_lista_suministros_valor'])->name('ver.lista.suministros.valor');
    ...
    Route::get('/listar_cotizadores', [BienController::class, 'listar_cotizadores'])->name('listar.cotizadores');
    ...
    Route::get('/listar_todo_orden_compra_almacen', [AlmacenController::class, 'listar_todo_orden_compra'])->name('listar.todo.orden.compra.almacen');
    Route::post('/listar_todo_orden_compra_almacen_valor', [AlmacenController::class, 'listar_todo_orden_compra_valor'])->name('listar.todo.orden.compra.almacen.valor');
    Route::get('recepcion_orden_compra_almacen', [AlmacenController::class, 'recepcion_orden_compra']);
    ...
    //compra
    Route::get('proveedor_compra', [CotizadorController::class, 'proveedor_compra']);
    Route::get('/lista_pedido_compra_cotizador', [CotizadorController::class, 'lista_pedido_compra'])->name('lista.pedido.compra.cotizador');
    Route::post('/lista_pedido_compra_cotizador_valor', [CotizadorController::class, 'lista_pedido_compra_valor'])->name('lista.pedido.compra.cotizador.valor');
    Route::post('/lista_pedido_articulo_compra_cotizador', [CotizadorController::class, 'lista_pedido_articulo_compra'])->name('listar.pedido.articulo.compra.cotizador');
    Route::post('/recuperar_datos_almacenados_compra', [CotizadorController::class, 'recuperar_datos_almacenados'])->name('recuperar.datos.almacenados.compra');
    Route::post('/recuperar_datos_almacenados_compra2', [CotizadorController::class, 'recuperar_datos_almacenados2'])->name('recuperar.datos.almacenados.compra2');
    Route::post('/guardar_datos_compra_descargar', [CotizadorController::class, 'guardar_datos_compra_descargar'])->name('guardar.datos.compra.descargar');
    Route::post('/listar_orden_compra', [CotizadorController::class, 'listar_orden_compra'])->name('listar.orden.compra');
    Route::post('/ver_imprimir_orden_cotizador_compra', [CotizadorController::class, 'ver_imprimir_orden_compra'])->name('ver.imprimir.orden.compra');
    Route::get('recepcion_compra', [CotizadorController::class, 'recepcion_compra']);
    Route::get('/listar_todo_orden_compra', [CotizadorController::class, 'listar_todo_orden_compra'])->name('listar.todo.orden.compra');
    Route::post('/listar_todo_orden_valor_compra', [CotizadorController::class, 'listar_todo_orden_valor_compra'])->name('listar.todo.orden.valor.compra');
