...
@section('title', 'Pedido de Activos Reales')
...
@section('content')
    <h1 class="page-header">Pedido de Activos Reales <small>Solicitud del Pedido</small></h1>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                ...
                                <!--<div class="form-group row m-b-10">
                                    <label class="col-lg-3 text-lg-right col-form-label">Categoria <span class="text-danger">*</span></label>
                                    <div class="col-lg-9 col-xl-6">
