                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-11 offset-xl-1">
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <textarea class="form-control" id="emplearse" name="emplearse" pattern="^[A-Za-zÑñ]([A-Za-z]|[0-9]|\.| )*" rows="3" minlength="5" maxlength="200" placeholder="CANTIDAD MÁXIMA DE LETRAS: 100" data-parsley-group="step-1" data-size="10" data-live-search="true" onkeyup="convertirEnMayusculas(this)" onkeypress="return solo_letras_numeros(event)" required></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 offset-xl-2">
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <textarea class="form-control formulario1" id="descripcion" name="descripcion" pattern="^[A-Za-zÑñ]([A-Za-z]|[0-9]|\.| )*" rows="3" minlength="1" maxlength="250" placeholder="CANTIDAD MÁXIMA DE LETRAS: 250" data-parsley-group="step-2" data-size="10" data-live-search="true" onkeyup="convertirEnMayusculas(this)" onkeypress="return solo_letras_numeros(event)"></textarea>
                                    </div>
                                </div>
...
/*     $.ajax({
    ...
    $.ajax({
        ...
        data:$(this).serialize(),
        success:function(unidad){
            $('#unidad').html(unidad[0]);

            let id_fun = unidad[1];
            $.ajax({
                type:'POST',
                url:'{{ route('estructura.programatica') }}',
                data:{ _token: '{{ csrf_token ()}}', id_unidad:id_fun},
                success:function(html){
                    $('#estruc_prog').val(html[1]+"/"+html[3]);
                    $('#estruc_prog2').val(html[1]+"/"+html[3]);
                }
            ...
            $.ajax({
                type:'POST',
                url:'{{ route('recuperar.superior.responsable') }}',
                data:{ _token: '{{ csrf_token ()}}', id:id_fun},
                success:function(responsable){
                    $('#responsable').html(responsable);
                }
