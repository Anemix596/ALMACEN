...
@section('content')
    ...
    <h1 class="page-header">Reporte de Cierre</h1>
		...
		<div class="col-xl-12">
			<div class="panel panel-inverse" data-sortable-id="form-validation-1">
				...
				<div class="panel-heading">
					<h4 class="panel-title">Reporte de Cierre - Materiales y Suministros</h4>
				</div>
				<div class="panel-body">
					<form id="reporte_cierre" action="{{ route('ver.imprimir.cierre') }}" method="POST" class="form-horizontal" data-parsley-validate="true">
						@csrf
...
<script>
    $(document).on("submit" ,"#reporte_cierre", function(e){
        $.ajaxSetup({
...
<script>
    $.ajax({
        type:'GET',
        url:'{{ route('recuperar.gestion.cierre') }}',
        data:$(this).serialize(),
        success:function(html){
            $('#anio').html(html);
        }
