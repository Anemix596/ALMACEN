        ...
        <form class="form-horizontal" id="filtrar" data-parsley-validate="true" name="demo-form">
            <div class="col-md-9">
                ...
                <div class="checkbox checkbox-css">
                    <input type="checkbox" name="ped_pendiente" id="ped_pendiente" value="1"
                        onchange="pendientes(this.value);" />
                    <label for="ped_pendiente">Ingresos Stock Pendientes</label>
                </div>
                <div class="checkbox checkbox-css is-valid">
                    <input type="checkbox" name="ped_aprobado" id="ped_aprobado" value="2"
                        onchange="aprobados(this.value);" />
                                ...
                                <div class="form-group m-b-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    <label for="" class="form-control" name="pedido"
                                                        id="pedido"></label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group m-b-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    <label for="" class="form-control" id="factura"
                                                        name="factura"></label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group m-b-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    <label for="" class="form-control" id="proveedor"
                                                        name="proveedor"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <form id="editar_datos" method="POST">
                                ...
                                <div class="form-group m-b-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    <label for="" class="form-control" id="fechaa"
                                                        name="fechaa"></label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group m-b-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    <label for="" class="form-control" name="pedidoa"
                                                        id="pedidoa"></label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group m-b-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    <label for="" class="form-control" id="facturaa"
                                                        name="facturaa"></label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group m-b-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    <label for="" class="form-control" id="ordena"
                                                        name="ordena"></label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group m-b-10">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row">
                                                <div class="col-lg-11">
                                                    <label for="" class="form-control" id="proveedora"
                                                        name="proveedora"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <div class="form-group row m-b-10">
                                <label class="col-lg-3 text-lg-right col-form-label">Glosa <span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-6">
                                    <textarea class="form-control" id="glosaa" name="glosaa"
                                        pattern="^[A-Za-z]([A-Za-z]|[0-9]|\.| )*" rows="3" minlength="5" maxlength="200"
                                        placeholder="CANTIDAD MÁXIMA DE LETRAS: 100" data-size="10"
                                        data-live-search="true" onkeyup="convertirEnMayusculas(this)"
                                        onkeypress="return solo_letras_numeros(event)" required></textarea>
                                </div>
                            </div>
                        </div>
                        <br>
...
<script
    src="{{ asset('/assets/plugins/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js')}}"></script>
