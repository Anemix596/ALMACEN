...
@section('title', 'Ingresos Inmediato')
...
@section('content')
    ...
    <h1 class="page-header">Lista de Ingresos Inmediato</h1>
    ...
    <div class="col-xl-12">
            ...
            <form class="form-horizontal" id="filtrar" data-parsley-validate="true" name="demo-form">
                <div class="col-md-9">
                    ...
                    <div class="checkbox checkbox-css">
                        ...
                        <label for="ped_pendiente">Ingresos Inmediato Pendientes</label>
                    </div>
                    <div class="checkbox checkbox-css is-valid">
                        ...
                        <label for="ped_aprobado">Ingresos Inmediato Aceptados</label>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">LISTA DE INGRESOS INMEDIATO</h4>
            </div>
    ...
    $(function(){
        ...
        $('#editar_datos').on("submit", function(e){
            e.preventDefault();
                ...
                $.ajax({
                    url:"{{route('guardar.datos.salida.inmediato')}}",
                    type:"POST",
                    datatype: "html",
                    data: formData,
                    cache:false,
...
<script>
    $(document).ready( function () {
        $('#lista').DataTable({
            pageLength:25,
            "ajax": {
                url: "{{route('listar.ingreso.inmediato')}}",
                type: 'GET'
            },
            columns: [
                        {data:'numero'  , name: 'numero'}, 
...
<script>
    function filtrar(dato1, dato2){
        ...
        $('#lista').DataTable({
            ...
            "ajax": {
                type:'POST',
                url:'{{ route('listar.salida.inmediato.valor') }}',
