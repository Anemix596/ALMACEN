            ...
            <form class="form-horizontal" id="filtrar" data-parsley-validate="true" name="demo-form">
                <div class="col-md-9">
                    ...
                    <div class="checkbox checkbox-css">
                        ...
                        <label for="ped_pendiente">Nota de Recepción Pendientes de Orden</label>
                    </div>
                    <div class="checkbox checkbox-css is-valid">
                        ...
                        <label for="ped_aprobado">Nota de Recepción Generados de Orden</label>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group date" id="datepicker-default" data-date-format="dd-mm-yyyy">
                                <input type="text" class="form-control" placeholder="Seleccione una Fecha" name="fecha_fac" id="fecha_fac" required/>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group date" id="datepicker-disabled-past" data-date-format="dd-mm-yyyy">
                                <input type="text" class="form-control" placeholder="Seleccione una Fecha" name="fecha_face" id="fecha_face" required/>
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div>
                            <div class="table-responsive">
                        ...
                        <form action="{{ route('finalizar.recepcion') }}" id="finalizar_rec" method="POST">
                           @csrf
                            ...
                            <div class="alert alert-danger m-b-0">
                                <h5><i class="fa fa-info-circle"></i> <b>¿Desea Finalizar los cambios de Nota de Recepción de la Orden Nº <label id="ordenv"></label> ?</b></h5>
...
<script>
    $(document).ready( function () {
        $('#lista').DataTable({
            pageLength:25,
            "ajax": {
                url: "{{route('listar.todo.orden.compra.almacen')}}",
                type: 'GET'
            },
            columns: [
                        {data:'numero'  , name: 'numero'}, 
...
<script>
    function filtrar(dato1, dato2){
        ...
        $('#lista').DataTable({
            ...
            "ajax": {
                type:'POST',
                url:'{{ route('listar.todo.orden.compra.almacen.valor') }}',
