                           ...
                           @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 offset-xl-0">
                                    <div class="form-group row m-b-10">
                                        <label class="col-lg-3 text-lg-right col-form-label">Estructura Programática Formato(XX/YY) <span class="text-danger">*</span> :</label>
                                        <div class="col-lg-12 col-xl-9">
                                            <div class="row row-space-9">
                                                <div class="col-8">
                                                    <input type="text" id="est_prog" name="est_prog" pattern="^[0-9]+/[0-9]+[0-9]$" placeholder="ESTRUCTURA PROGRAMÁTICA EN FORMATO(XX/YY)" data-parsley-group="step-1" data-parsley-required="true" class="form-control formulario1" onkeypress="return solo_numeros_est_prog(event)" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row m-b-10">
                                        <label class="col-lg-3 text-lg-right col-form-label">Estructura Programática F.F. <span class="text-danger">*</span> :</label>
                                        <div class="col-lg-12 col-xl-9">
                                            <div class="row row-space-9">
                                                <div class="col-8">
                                                    <input type="hidden" id="fuente_fnto" name="fuente_fnto" required/>
                                                    <input type="text" id="fuente_fnto2" name="fuente_fnto2" placeholder="FINANCIMIENTO" data-parsley-group="step-1" data-parsley-required="true" class="form-control formulario1" required disabled/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 offset-xl-0">
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-lg-12 col-xl-9">
                                            <div class="row row-space-9">
                                                <div class="col-8">
                                                    <input type="text" id="eest_prog" name="eest_prog" pattern="^[0-9]+/[0-9]+[0-9]$" placeholder="ESTRUCTURA PROGRAMÁTICA EN FORMATO(XX/YY)" data-parsley-group="step-1" data-parsley-required="true" class="form-control formulario1" onkeypress="return solo_numeros_est_prog(event)" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    function solo_numeros_est_prog (e) {
        key=e.keyCode || e.which;
        teclado=String.fromCharCode(key).toLowerCase();
        letras_num="1234567890/";
        especiales="8-37-38-46-164";
