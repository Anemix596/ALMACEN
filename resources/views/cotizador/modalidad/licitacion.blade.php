    ...
    <div class="col-xl-12">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="guardar_datos_cotizacion" method="POST">
                           @csrf
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Adjuntar Archivo de Contrato <span class="text-danger">*</span> :</label>
                                <div class="col-md-8 col-sm-8">
        ...
        <div class="modal" id="modal-without-animation4" role="dialog" style="overflow-y: scroll">
            <div class="modal-dialog" style="max-width: 70% !important;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="titulo2">Llene los Campos del Contrato</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <form id="guardar_datos_orden" method="POST">
                           ...
                           <input type="hidden" id="proveedore2" name="proveedore2" value="">
                           <input type="hidden" id="id_prov" name="id_prov" value="">
                           <input type="hidden" id="ofertae2" name="ofertae2" value="">
                           <input type="hidden" id="tiempoe2" name="tiempoe2" value="">

                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Fecha de Contrato</label>
                                <div class="input-group date" id="datepicker-default2" data-date-format="dd-mm-yyyy">
                                    <input type="text" class="form-control" placeholder="Seleccione la Fecha del Contrato" name="fecha_cote2" id="fecha_cote2" required/>
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <label class="col-lg-4 col-form-label">Proveedor</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" id="proveedore2d" name="proveedore2d" placeholder="Proveedor" data-parsley-required="true" onkeypress="return solo_numeros(event)" required disabled/>
                                </div>
                            </div>
                            
                            <div class="form-group row">

                                <label class="col-lg-4 col-form-label">Nº de Contrato</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" pattern="^[0-9]{4}/[0-9]{4}$" id="contratoe2" name="contratoe2" placeholder="Nº de Contrato" data-parsley-required="true" onkeypress="return solo_numeros_contrato(event)" required/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Validez de la Oferta (días)</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" id="ofertae2d" name="ofertae2d" placeholder="Validez de la Oferta en Días" data-parsley-required="true" onkeypress="return solo_numeros(event)" required disabled/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Tiempo de Entrega en Oficinas UATF (días)</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" id="tiempoe2d" name="tiempoe2d" placeholder="Tiempo de Entrega en Días" data-parsley-required="true" onkeypress="return solo_numeros(event)" required disabled/>
                                </div>
                            </div>

                            <div class="form-group row">

                                <label class="col-lg-4 col-form-label">Monto Adjudicado (Bs.)</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" id="montoe2" name="montoe2" placeholder="Precio Total" data-parsley-required="true" onkeypress="return solo_numeros_contrato(event)" required disabled/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Adjuntar Archivo <span class="text-danger">*</span> :</label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="file" name="archivoe2" id="archivoe2" accept=".pdf" required>
                                </div>
                            </div>
                            <div class="table-responsive">
        ...
        <div class="modal" id="modal-without-animation5" role="dialog" style="overflow-y: scroll">
            <div class="modal-dialog" style="max-width: 70% !important;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="titulo2">Actualizar Datos del Contrato</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <form id="editar_datos_orden" method="POST">
                           ...
                           <input type="hidden" id="proveedore2o" name="proveedore2o" value="">
                           <input type="hidden" id="ofertae2o" name="ofertae2o" value="">
                           <input type="hidden" id="tiempoe2o" name="tiempoe2o" value="">
                           <input type="hidden" id="id_provo" name="id_provo" value="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" id="proveedore2od" name="proveedore2od" placeholder="Proveedor" data-parsley-required="true" onkeypress="return solo_numeros(event)" required disabled/>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <label class="col-lg-4 col-form-label">Nº de Contrato</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" pattern="^[0-9]{4}/[0-9]{4}$" id="contratoe2o" name="contratoe2o" placeholder="Nº de Contrato" data-parsley-required="true" onkeypress="return solo_numeros_contrato(event)" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Validez de la Oferta (días)</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" id="ofertae2od" name="ofertae2o" placeholder="Validez de la Oferta en Días" data-parsley-required="true" onkeypress="return solo_numeros(event)" required disabled/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Tiempo de Entrega en Oficinas UATF (días)</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" id="tiempoe2od" name="tiempoe2o" placeholder="Tiempo de Entrega en Días" data-parsley-required="true" onkeypress="return solo_numeros(event)" required disabled/>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <label class="col-lg-4 col-form-label">Monto Adjudicado (Bs.)</label>
                                <div class="col-md-8 col-sm-8">
                                    <input class="form-control" type="text" id="montoe2o" name="montoe2o" placeholder="Precio Total" data-parsley-required="true" onkeypress="return solo_numeros_contrato(event)" required disabled/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label">Adjuntar Archivo <span class="text-danger">*</span> :</label>
                                <div class="col-md-8 col-sm-8">
                                    <input type="file" name="archivoe2o" id="archivoe2o" accept=".pdf" required>
                                </div>
                            </div>
                            <div class="table-responsive">
...
<script>
    function imprimir_orden(dato, dato2){
        $.ajax({
            type:'POST',
            url:'{{ route('ver.imprimir.orden.cotizador.lic_exc') }}',
...
<script>
    function filtrar(dato1, dato2){
        ...
        $('#lista').DataTable({
            ...
            "ajax": {
                type:'POST',
                url:'{{ route('lista.pedido.licitacion.cotizador.valor') }}',
                        ...
                        {data: 'val2' , 
                            render: function(name){
                                ...
                                if(v == 1){
                                    ...
                                    for (let i = 1; i <= 1; i++) {
                                        html+='<abbr title="Ver PDF Contrato Digitalizado"><button onclick="imprimir_orden('+pe+','+i+')" class="btn btn-info"><i class="fas fa-file-pdf"></i></button>&nbsp;</abbr><br>';
                                    }
                                    return html;
                                }
                                else if(v == 3){
                                    ...
                                    for (let i = 1; i <= 1; i++) {
                                        html+='<abbr title="Ver PDF Contrato Digitalizado"><button onclick="imprimir_orden('+pe+','+i+')" class="btn btn-info"><i class="fas fa-file-pdf"></i></button>&nbsp;</abbr>';
                                    }
                                    return html;
                                }
                                else return '';
...
<script>
    $(document).ready( function () {
        $('#lista').DataTable({
            "ajax": {
                url: "{{route('lista.pedido.licitacion.cotizador')}}",
                type: 'GET'
            },
            columns: [
                        {data:'numero'  , name: 'numero'}, 
