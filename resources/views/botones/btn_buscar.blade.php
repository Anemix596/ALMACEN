@switch($valor)
    ...
    @case(7) 
        <div class="form-inline">
          @if ($est_almacen == "PENDIENTE")
                @if ($estado == "PENDIENTE")
                    <abbr title="Mostrar Artículos">
                        <button onclick="ver('{{$no_pedido}}'); listar_cotizadores();" class="btn btn-info" data-toggle="modal" data-target="#modal-without-animation">
                            <i class="far fa-eye"></i>
                        </button>&nbsp;
                    </abbr>
                @endif
                @if ($estado == "ASIGNADO")
                    <abbr title="Mostrar Artículos">
                        <button onclick="editar('{{$no_pedido}}'); elistar_cotizadores();" class="btn btn-info" data-toggle="modal" data-target="#modal-without-animation2">
                            <i class="far fa-eye"></i>
                        </button>&nbsp;
                    </abbr>
                @endif
    ...
    @case(39) 
        <div class="form-inline">
            ...
            <input type="hidden" name="articulo[]" id="articulo" value="{{$articulo}}">
            @if ($check == "SI")
                <input type="checkbox" id="compra" name="compra[]" value="{{$numero}}" onchange="verificarCheckboxes()"/>
            @endif
    ...
    @case(40) 
        <div class="form-inline">
            <input type="text" name="preciou[]" id="preciou" value="0.00" onkeypress="return solo_numeros_precio(event)" required>
            <input type="hidden" name="id_solicitud" id="id_solicitud" value="{{$id_solicitud}}">
            <input type="hidden" name="id_sol_det[]" id="id_sol_det" value="{{$id_sol_det}}">
            <input type="hidden" name="id_cot[]" id="id_cot" value="{{$id_cot}}">
            <input type="hidden" name="id_articulo[]" id="id_articulo" value="{{$id_articulo}}">
            <input type="hidden" name="cantidad[]" id="cantidad" value="{{$cantidad}}">
            <input type="hidden" name="no_pedido" id="no_pedido" value="{{$no_pedido}}">
        </div>
        @break
    @case(41) 
        <div class="form-inline">
    ...
    @case(42) 
        <div class="form-inline">
            ...
            <abbr title="Ver Orden de Compra">
                <a onclick="imprimir_orden('{{$orden}}', '{{$pedido}}')" class="btn btn-pink" data-toggle="modal" data-target="" href="#">
                    <i class="fas fa-file-pdf"></i>
                </a>&nbsp;
            </abbr>
        </div>
